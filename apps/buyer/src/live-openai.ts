/** An OpenAI-powered buyer, added alongside the Claude-powered one at the user's request, a second, independent implementation of the buyer harness. */
...
async function main() {
  if (!process.env.OPENAI_API_KEY) {
    console.log(
      "OPENAI_API_KEY is not set, this is the OpenAI-powered buyer and needs it.\n" +
  ...
  console.log(`server up at ${baseUrl} (OpenAI buyer, model=${model})\n`);
